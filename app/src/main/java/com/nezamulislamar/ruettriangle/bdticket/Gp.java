...
public class Gp extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		b[1] = (Button)findViewById(R.id.reGister);
		b[2] = (Button)findViewById(R.id.gpCounter);
		b[3] = (Button)findViewById(R.id.BuYTickEtGP);
        ...
        b[2].setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent event) {
				...
				case   MotionEvent.ACTION_DOWN:
					...
					break;
				case MotionEvent.ACTION_UP:
					Intent docs = new Intent(Gp.this,HelpDetails.class);
					docs.putExtra("help", 10);
					startActivity(docs);
